Це вправа є дуже важливою тому, що потоки, канали і списки команд використовуються повсюдно. Ви могли зустріти ці дивні `>` і `|` символи майже в любому скрипті. Отже, давайте відкриємо секрет, що це саме таке.
